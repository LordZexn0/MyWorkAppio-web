...
export default function HeroSection({ onCTAClick }: HeroSectionProps) {
  ...
  return (
    <div className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 w-full h-full bg-gradient-to-b from-blue-50 to-orange-50"></div>

      {/* Video with direct path */}
      <video
        ref={videoRef}
        autoPlay
        loop
      ...
      <div className="relative z-20 flex flex-col items-center justify-center h-full px-4 text-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl lg:text-3xl font-bold text-black max-w-3xl mx-auto">
